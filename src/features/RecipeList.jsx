...
const { setFavoriteList, setIsEditing } = useContext(RecipesContext);
  ...
  {recipe.isFavorite&&<RecipeActionBtns onEdit={()=>handleEditRecipe(recipe)} onRemove={()=>handleRemoveRecipe(recipe)} onAdd={()=>handleAddRecipe(recipe)} isFavorite={recipe.isFavorite}/>}
