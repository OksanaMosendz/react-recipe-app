  ...
  return (
    ...
    >
      <InputWithLabel
        ...
        onChange={(e) =>
          setCreatedRecipe({ ...createdRecipe, name: e.target.value })
        }
      />
      ...
      <ul className={styles.ingr_list}>
        {ingredients.map((ingr, i) => (
          <li className={styles.ingr_item} key={ingr.id + ingr.name}>
            ...
            />
            <Button
              className={styles.ingr_del_btn}
              text="X"
              handleEvent={() => handleRemoveIngr(i)}
            />
          </li>
        ))}
      </ul>
      ...
      <Button
        className={styles.ingr_btn}
        text="add ingridient"
        handleEvent={() =>
          setIngredients([
            ...ingredients,
            { name: "", measure: "", id: `${Date.now()}` },
          ])
        }
      />
      <div className={styles.textArea_wrap}>
        ...
        <textarea
          ...
          onChange={(e) =>
            setCreatedRecipe({ ...createdRecipe, instructions: e.target.value })
          }
        ></textarea>
      </div>
      <div className={styles.form_btns}>
        <Button
          text="Save"
          type="submit"
          disabled={!createdRecipe.name}
          id="createRecipe"
        />
        <Button text="Cancel" handleEvent={() => setIsEditing(false)}>
          Cancel
        </Button>
      </div>
    </form>
